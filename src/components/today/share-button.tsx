...
export function ShareButton({
   ...
   * (default). "inline": a full-width static button meant to sit inside
   * the desktop sidebar's stats panel - see TodayStatsPanel's own
   * comment and design/project/desktop-redesign/TodayDesktop.dc.html,
   * which moves Share there instead of floating (it used to visually
   * collide with the last checklist row on desktop). */
